...
asset="9001 57fca08abbaddee36da742a839f7d83a7e1d2419f1507fcbf3916522.43484f43 + 2500000000 698a6ea0ca99f315034072af31eaac6ec11fe8558d3f48e9775aab9d.7444524950"

min_utxo=$(${cli} transaction calculate-min-required-utxo \
    --protocol-params-file tmp/protocol.json \
    --tx-out="${receiver_address} ${asset}" | tr -dc '0-9')
token_to_be_traded="${receiver_address} + ${min_utxo} + ${asset}"
# token_to_be_returned="${sender_address} + ${min_utxo} + 2500000000 698a6ea0ca99f315034072af31eaac6ec11fe8558d3f48e9775aab9d.7444524950"
